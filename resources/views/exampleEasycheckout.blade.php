...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            ...
            <p class="lead">Below is an example form built entirely with Bootstrap's form controls. We have provided
                this sample form for understanding EasyCheckout (Popup) Payment integration with SSLCommerz.</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form action="{{ route('pay') }}" method="post" id="payment-form">
                    ...
                    <!-- Customer Name (maps to 'name' in orders table) -->
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="customer_name">Full name</label>
                            <input type="text" name="customer_name" value="sayem" class="form-control"
                                id="customer_name" placeholder="Enter your full name" required>
                    ...
                    <!-- Customer Mobile (maps to 'phone' in orders table) -->
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="customer_mobile" class="form-control" id="customer_mobile"
                                placeholder="Mobile" value="01711123456" required>
                    ...
                    <!-- Customer Email (maps to 'email' in orders table) -->
                    <div class="mb-3">
                        <label for="customer_email">Email</label>
                        <input type="email" name="customer_email" class="form-control" id="customer_email"
                            placeholder="you@example.com" value="customer@example.com" required>
                        <div class="invalid-feedback">
                            Please enter a valid email address for shipping updates.
                        </div>
                    </div>

                    <!-- Customer Address (maps to 'address' in orders table) -->
                    <div class="mb-3">
                    ...
                    <!-- Hidden fields for amount (maps to 'amount' in orders table) -->
                    <input type="hidden" value="1200" name="amount" id="total_amount" required />

                    <!-- Hidden field for currency (maps to 'currency' in orders table) -->
                    <input type="hidden" value="BDT" name="currency" id="currency" />
                ...
                <button class="btn btn-primary btn-lg btn-block" type="button" id="sslczPayBtn"
    ...
    <!-- jQuery Full version (needed for AJAX) -->
    ...
    <!-- SSLCommerz Popup Integration -->
    <script>
        var obj = {};
        $('#sslczPayBtn').click(function(e) {
            // Capture form data for SSLCommerz
            obj.customer_name = $('#customer_name').val();
            obj.customer_mobile = $('#customer_mobile').val();
